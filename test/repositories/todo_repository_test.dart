...
import 'package:flutter_cl/repositories/todo_repository.dart';
...
void main() {
  ...
  group('fetchTodos', () {
    test('deve trazer uma lista de TodoModel', () async {
      when(client.get<dynamic>(repository.url))
    ...
    test('falha no retorno do teste', () {
      when(client.get<dynamic>(repository.url))
          .thenAnswer((_) async => Response(
                data: 'Not found',
                statusCode: 404,
      ...
      final list = repository.fetchTodos();
